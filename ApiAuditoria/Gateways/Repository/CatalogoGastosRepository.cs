...
namespace ApiAuditoria.Gateways.Repository
{
    public class CatalogoGastosRepository : ICatalogoGastosRepository
    {
        ...
        {
            string sp_api = "EXEC api_ActualizaCatalogoGastos @i_cg_empresa, @i_cg_codigo, @i_cg_categoria, @i_cg_descripion, @i_cg_estado, @i_Operador, @o_return, @o_msg";
            ...
            List<SqlParameter> parms = new List<SqlParameter>
            {
                ...
                new SqlParameter { ParameterName = "@i_cg_categoria", Value = catalogoGastos.cg_categoria},
        ...
        {
            string sp_api = "EXEC api_IngresoCatalogoGastos @i_cg_empresa, @i_cg_codigo, @i_cg_categoria, @i_cg_descripion, @i_cg_estado, @i_Operador, @o_return, @o_msg";
